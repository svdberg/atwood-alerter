...
def setup_frontend(scope: Construct, certificate_arn: str, webpush_lambda, env_config: EnvironmentConfig):
    # 1. S3 Bucket
    ...
    CfnOutput(scope, "CloudFrontURL", value=f"https://{distribution.distribution_domain_name}")
