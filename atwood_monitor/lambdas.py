...
def create_lambda_layer(scope: Construct, env_config: EnvironmentConfig) -> lambda_.LayerVersion:
...
def create_scraper_lambda(scope: Construct, role, layer, posts_table, users_table, notify_topic: sns.Topic, env_config: EnvironmentConfig) -> lambda_.Function:
    fn = lambda_.Function(
...
def create_status_lambda(scope: Construct, role, layer, posts_table, env_config: EnvironmentConfig) -> lambda_.Function:
    fn = lambda_.Function(
        scope, "StatusLambda",
...
def create_subscribe_lambda(scope: Construct, role, layer, users_table, notify_topic: sns.Topic, env_config: EnvironmentConfig) -> lambda_.Function:
    fn = lambda_.Function(
...
def create_register_web_push_lambda(scope: Construct, role, web_push_table, env_config: EnvironmentConfig) -> lambda_.Function:
    fn = lambda_.Function(
...
def create_web_push_lambda(scope: Construct, web_push_table, web_notify_topic, env_config: EnvironmentConfig) -> lambda_.DockerImageFunction:
